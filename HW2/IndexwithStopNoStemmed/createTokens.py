...
# has stopwords and the words are not stemmed
...
def createUniqueTerms(text,doc_id,countUniqueTerm,term_block_map, totalCF):
    position = 0
...
def mergeFiles(file_1, file_2, mergeCount,i):
    mergeFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopNoStemmed/tuples/merge_" + str(mergeCount) + "_" + str(i)
...
if __name__ == "__main__":
    ...
    tupleFilePath = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopNoStemmed/tuples/"
    ...
    #for i in range (0,20,5):
        ...
        if i+50 < 364:
            ...
            #fileNames = docNames[i:i+5]
        else:
            fileNames = docNames[i:364]
            #fileNames = docNames[i:20]
        print fileNames
        term_block_map = {}
            ...
            with open(full_filename) as lines:
                for line in iter(lines):
                    if doc_close_tag in line:
                        uniqueTermCount, term_block_map, totalCF = createUniqueTerms(text,doc_id,uniqueTermCount,term_block_map,totalCF)
                        text = ""
    ...
    indexParamsFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopNoStemmed/indexParams.txt"
    ...
    uniqueTermFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopNoStemmed/uniqueTerms.txt"
    # file that stores the (document, doc_id) pair
    docNameFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopNoStemmed/docNames.txt"
