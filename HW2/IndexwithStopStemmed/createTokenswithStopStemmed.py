...
# has stop words and the words are stemmed
...
def createUniqueTerms(text,doc_id,countUniqueTerm,term_block_map, totalCF):
    ...
    if matchObj:
        for term in matchObj:
            position += 1
            totalCF += 1
            query_word = term.group().lower()
            #if query_word not in stopList:
...
def mergeFiles(file_1, file_2, mergeCount,i):
    mergeFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopStemmed/tuples/merge_" + str(mergeCount) + "_" + str(i)
...
if __name__ == "__main__":
    ...
    tupleFilePath = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopStemmed/tuples/"
    ...
    indexParamsFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopStemmed/indexParams.txt"
    ...
    uniqueTermFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopStemmed/uniqueTerms.txt"
    # file that stores the (document, doc_id) pair
    docNameFile = "/Users/snehagaikwad/Documents/IR_data/AP_DATA/IndexwithStopStemmed/docNames.txt"
